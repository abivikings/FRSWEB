...
const AnalyticsEarningReports = () => {
  ...
  const options = {
    ...
    const data = [
      {
        progress: 64,
        stats: apiData.goal ? `$${apiData.goal}` : 'Loading...',
        title: 'Goals',
      ...
      },
      {
        progress: 59,
        title: 'Raised',
        stats: apiData.raised ? `$${apiData.raised}` : 'Loading...',
        avatarColor: 'info',
        progressColor: 'info',
      ...
      {
        progress: 22,
        stats: apiData.remaining ? `$${apiData.remaining}` : 'Loading...',
        title: 'To Go',
        avatarColor: 'error',
        progressColor: 'error',
  ...
  return (
    <Card>
      <CardHeader
        ...
        subheader='All Campaign Overview'
        action={
          <OptionsMenu
